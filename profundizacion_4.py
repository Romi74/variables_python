...
nombre_completo_padre = str(input("ingrese nombre completo del padre: "))
nombre_completo_madre =str(input("ingrese nombre completo del madre: "))
nombre_hijo = str(input("ingrese nombre del hijo/a: ")) 

nombre_completo_padre.split()
nombre_completo_madre.split()

nombre_padre, apellido_padre = nombre_completo_padre.split()
nombre_madre, apellido_madre =  nombre_completo_madre.split()

nombre_completo_hijo = nombre_hijo + " " + apellido_padre + " " + apellido_madre

print("nombre completo del hijo/a: ",nombre_completo_hijo)

print("Termine ejercicios profundizacion variables!! a ver como resultaron!")
